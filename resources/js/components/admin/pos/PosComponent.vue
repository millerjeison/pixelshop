    ...
    <div class="p-4">
      ...
      <div class="flex w-full h-[38px] mt-4 mb-4" v-if="carts.length > 0">
        <div class=" w-full db-field-down-arrow">
          <select v-model="checkoutProps.form.pos_payment_method"
            class="w-full h-full cursor-pointer text-sm font-client rounded-md appearance-none border ltr:pl-3 rtl:pr-3 text-heading border-[#EFF0F6]">
      ...
      <div class="flex h-[38px]"
        ...
        <input v-model="checkoutProps.form.pos_payment_note" type="text"
          ...
          class="w-full h-full border rounded-md px-3 border-[#EFF0F6]">
      </div>
